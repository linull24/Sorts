...
void Select(Score *a, int size, unsigned long int *comparisons, unsigned long int *assignments);		// 选择排序(按总分降序排序)
void Qsort(Score *a, int size, unsigned long int *comparisons, unsigned long int *assignments);			// 快速排序(按总分降序排序)
